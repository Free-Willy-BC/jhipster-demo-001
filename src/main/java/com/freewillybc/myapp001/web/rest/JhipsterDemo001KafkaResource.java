...
@RestController
@RequestMapping("/api/jhipster-demo-001-kafka")
public class JhipsterDemo001KafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterDemo001KafkaResource.class);
    ...
    public JhipsterDemo001KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
